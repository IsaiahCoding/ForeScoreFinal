...
// import ScoreCardForm from './ScoreCardForm'; // Import ScoreCardForm component
...
//       {/* Render ScoreCardForm component if user is logged in */}
//       {loggedInUser && <ScoreCardForm onSubmit={handleFormSubmit} />}
//       <div className="mt-8">
